...
function print_deliveries()
{
	...
	$cols = array(4, 60, 380, 500);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'center', 'left');
...
//                $item=get_item($myrow2['stk_code']);
		...
		$rep->MultiCell(50, 490,"Total Qty", 0, 'R', 0, 1, 350,705);
$rep->MultiCell(50, 490,price_format($total_qty), 0, 'R', 0, 1, 440,705);
...
//    			}
	...
	$rep->NewLine();
        $rep->TextCol(0, 9,	_("Prepared By                                                                    Approved By                                                                 GM/Store"), -2);
