...
function print_Chart_of_Accounts()
{
	...
	$cols = array(2, 50, 180, 385, 445, 430);
...
//    $rep->MultiCell(200, 60, "".htmlspecialchars_decode(get_branch_name_od($from_trans['person_id'])) ,0, 'L', 0, 2, 110,155, true);
	...
	$amount_2 += abs($from_trans['amount']);
...
//    $rep->MultiCell(250, 20, "DATE:  ".$date ,0, 'L', 0, 2, 450,50, true);
	...
	$rep->MultiCell(160, 20, "Journal Ref:  ". /*$from_trans["ref"] */get_reference(ST_JOURNAL,$trans_no),0, 'L', 0, 2, 330,140, true);
...
//            $rep->NewLine(1);
		...
		if($myrow1['amount'] >0)
		{
			...
			$rep->MultiCell(120, 20, number_format2($myrow1['amount'] * -1), 1, 'C', 0, 2, 420, 340, true);

			$rep->MultiCell(100, 25, "" . number_format2($myrow1['amount'] * -1), 0, 'C', 0, 2, 450, 320, true);

			$amounts = ($myrow1['amount'] * -1);
			$rep->MultiCell(350, 20, 'Rupees:' . convert_number_to_words($amounts) . ' Only', 1, 'L', 0, 2, 60, 340, true);


			$rep->MultiCell(100, 25, "".number_format2($myrow1['amount'] * -1), 0, 'C', 0, 2, 490, 320, true);
...
//        alt_table_row_color($k);
	...
	$rep->MultiCell(100, 25, "".get_user_name_70123($user['user']) ,0, 'C', 0, 2, 37,378, true);
	$rep->MultiCell(100, 25, "Prepared By" ,0, 'C', 0, 2, 40,400, true);
	$rep->MultiCell(100, 25, "Approved By" ,0, 'C', 0, 2, 160,400, true);
	$rep->MultiCell(100, 25, "Checked By" ,0, 'C', 0, 2, 290,400, true);
	$rep->MultiCell(100, 25, "Recieved By" ,0, 'C', 0, 2, 390,400, true);
	$rep->MultiCell(100, 25, "Total" ,0, 'C', 0, 2, 350,320, true);
	$rep->MultiCell(525, 17, "" ,1, 'C', 0, 2, 40,315, true);
...
//
	...
	$rep->font('b');
//    $rep->setfontsize(0);
	$rep->MultiCell(177,33, "",1, 'C', 0, 2, 40,181, true);
	$rep->MultiCell(45,33, "",1, 'C', 0, 2, 40,181, true);
//    $rep->MultiCell(170, 15, "Account",0, 'C', 0, 2, 15,181, true);
	$rep->MultiCell(230, 15, "",0, 'C', 0, 2, 210,186, true);
	$rep->MultiCell(50, 33.3, "",1, 'C', 0, 2, 421,181, true);
	$rep->MultiCell(55, 33.3, "Cost",0, 'C', 0, 2, 409,181, true);
	$rep->MultiCell(48, 15, "Debit",1, 'C', 0, 2, 471,181, true);
	$rep->MultiCell(46, 15, "Credit",1, 'C', 0, 2, 519,181, true);
	$rep->MultiCell(204, 33, "",1, 'C', 0, 2, 217,181, true);
