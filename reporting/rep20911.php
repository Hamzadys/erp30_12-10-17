...
//
        ...
        $rep->MultiCell(300,10,"REMARKS :".$gst_nos['narrative'],0,'L',0,0,500,75);
        $rep->MultiCell(90,10,"DATE :".sql2date($gst_nos['application_date']),0,'L',0,0,500,90);
...
//    $rep->multicell(450,50,"",1,'L',0,0,110,735);
    ...
    // $application_date = date("d-m-Y h:i:sa", strtotime($myrow['application_date']));
    // $rep->multicell(200, 12, $application_date, 0,'L', 0, 0, 100, 545);
    $rep->multicell(200,12,$myrow['application_date'],0,'L',0,0,100,545);
