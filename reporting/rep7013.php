...
function print_Chart_of_Accounts()
{
  ...
  // $rep->MultiCell(240, 30, "".get_branch_name_od($from_trans['person_id']) ,0, 'L', 0, 2, 110,155, true);
    ...
    $rep->MultiCell(350, 20,"Amount in Words:  " . convert_number_to_words(abs($from_trans['amount']))." "."Only",1, 'L', 0, 2, 40,340, true);
...
//
  $rep->MultiCell(120, 20, number_format2(abs($from_trans['amount'])),1, 'C', 0, 2, 420,340, true);
