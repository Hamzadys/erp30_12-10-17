...
*/
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				...
				'bcc_email', 'alternative_tax_include_on_docs', 'suppress_tax_rates',
				'use_fixed_assets','logo_h','logo_w','back_days','future_days','deadline_time'/*,'bank_details','bank_account'*/))
...
text_row_ex(_("Deadline Time :"), 'deadline_time', 10, 10, 'Blank = Disable,require time Disallowed', date('h:i:s'), null, _('Time Entry.'));
